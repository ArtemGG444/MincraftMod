...
import net.mcreator.mechacraft.procedures.MechaFurnaceUpdateTickProcedure;
import net.mcreator.mechacraft.procedures.MechaFurnaceOnBlockRightClickedProcedure;
...
public class MechaFurnaceBlock extends MechacraftModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				MechaFurnaceOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
