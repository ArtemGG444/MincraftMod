...
import net.mcreator.mechacraft.procedures.EnergyMeterRightClickedOnBlockProcedure;
...
public class EnergyMeterItem extends MechacraftModElements.ModElement {
	@ObjectHolder("mechacraft:energy_meter")
	public static final Item block = null;
	public EnergyMeterItem(MechacraftModElements instance) {
		super(instance, 3);
	}
